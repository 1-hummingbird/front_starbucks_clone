...
export const newProducts: Product[] = [
  ...
  },
  {
    id: 8,
    productId: "16",
    name: "[추석선물] 스타벅스 핸드 타월 세트 (3P) x 2ea",
    price: 10016,
    icon: {
