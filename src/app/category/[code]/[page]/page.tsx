...
import { getProductIdsByCategory, getCategoryName } from '@/action/productActions';

export default async function Page({ params }: { params: { code: string, page: string } }) {
  const products = await getProductIdsByCategory(params.code, parseInt(params.page));
